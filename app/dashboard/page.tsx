    ...
    <div>
      <div className="font-medium">
        {orders.map((order) => (
          ...
          >
            <h2 className="text-xs font-medium">Order refrence: {order.id}</h2>
            <p>Time: {new Date(order.createdDate).toLocaleString()}</p>
            <p className="text-xs ">
              Status:{" "}
              <span
                className={`${
            ...
            <p className="text-xs">Total: {PriceFormat(order.amount)}</p>
